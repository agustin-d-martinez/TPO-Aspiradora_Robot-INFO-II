...
CPP_SRCS += \
../src/Drivers/04-inputs/inputs.cpp 

OBJS += \
./src/Drivers/04-inputs/inputs.o 

CPP_DEPS += \
./src/Drivers/04-inputs/inputs.d 


# Each subdirectory must supply rules for building sources it contributes
src/Drivers/04-inputs/%.o: ../src/Drivers/04-inputs/%.cpp src/Drivers/04-inputs/subdir.mk
	@echo 'Building file: $<'
